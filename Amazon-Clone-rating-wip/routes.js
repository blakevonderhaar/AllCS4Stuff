...
router.post("/updateRating",function(req,res){//edited
	if(req.body.name == "" || req.body.rating == "" || req.body.numRating == "")
		res.json(null);
	else{
		console.log("this is the rating being passed in "  + req.body.rating + " num rating " + req.body.numRating);
		itemDB.updateItem(req.body,res);
	}
});
